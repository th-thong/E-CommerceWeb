...
urlpatterns = [
    ...
    path('shopadmin/feedbacks/', fav.get_all_feedbacks, name="get_all_feedbacks"),
    path('shopadmin/approve-feedback/<int:feedback_id>/', fav.approve_feedback, name="approve_feedback"),
    path('shopadmin/delete-feedback/<int:feedback_id>/', fav.delete_feedback, name="delete_feedback"),
